 ...
 *
 * @param initial_capacity the initial capacity of the newly created vector, non negative
 ...
 * Capacity is doubled. If initial capacity is zero, it is resized to capacity 1.
 * Any pointers to elements prior to this reallocation are invalidated.
 */
 ...
 * then this function will panic().
 * @post If after the operation the new length is greater than the old capacity
 * then a reallocation takes place and all elements are copied over. Capacity is doubled.
 * Any pointers to elements prior to this reallocation are invalidated.
 */
